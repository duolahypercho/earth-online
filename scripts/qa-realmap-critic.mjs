...
lines.push('4. **Real-map interiors use four generated archetypes, not authored micro-scenes.** Cafe, office, rowhouse, and market rooms now select by OSM metadata and are distinguishable, but they are still procedural shells without resident schedules or authored story content.');
lines.push('');
