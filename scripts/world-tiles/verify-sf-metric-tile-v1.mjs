...
assert.equal(receipt.source.osmPbf.sha256, 'dda3821dd92f8d8bf34abe503ac81f20a439ee02a210a9d68d2c7c5d66fb0cae'); assert.equal(receipt.source.geoTiff.sha256, '9cc9c03f4ddaf8ec6712951b980157ea02293c7723761466e6e60f21147a9424'); assert(mapPackage.sourceFeatures.length > 0, 'Expected OSM way coverage');
for (const feature of mapPackage.sourceFeatures) { assert.match(feature.sourceFeatureId, /^way\/\d+$/); assert.equal(feature.nativeHorizontalCrs, 'EPSG:4326'); assert.equal(feature.verticalMode, 'terrain-sampled-source-declared-navd88-unrealized'); assert.equal(feature.elevationSampleEvidence.rasterSha256, '9cc9c03f4ddaf8ec6712951b980157ea02293c7723761466e6e60f21147a9424'); }
