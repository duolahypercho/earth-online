# GTA-level visual quality gate

**Independent audit date:** 2026-08-10  
**Scope:** read-only visual assessment of the current Earth Online / Real Map Lab
capture set. This is a quality gate, not a claim of equivalence with Rockstar
Games technology or a redistribution of Rockstar material.

## Current official benchmark

Use **Grand Theft Auto VI (GTA VI)** as the current Rockstar visual benchmark.
Rockstar's official GTA VI site currently lists the game as coming to PS5 and
Xbox Series X|S on **November 19, 2026**. The official media page contains the
current 70-image screenshot collection and 11 official videos. The relevant
visual release baseline is Rockstar's official **Trailer 2** and official media
gallery; do not infer technical features not explicitly shown by Rockstar.

- [Official GTA VI game page](https://www.rockstargames.com/VI)
- [Official GTA VI media gallery](https://www.rockstargames.com/VI/media)
- [Official GTA VI screenshot gallery](https://www.rockstargames.com/VI/media/screenshots)
- [Rockstar: November 19, 2026 release-date announcement](https://www.rockstargames.com/newswire/article/ak3ak31a49a221/grand-theft-auto-vi-is-now-set-to-launch-november-19-2026)

**Copyright-safe process:** reviewers open those links themselves; do not copy,
commit, embed, train on, distribute, or publish Rockstar screenshots/video
frames in this repository or its generated reports. Store only the URL, page
title, access date, selected scene category, and reviewer scores. The existing
local `reference-*.jpg` assets are not documented as Rockstar material and must
not be described as a GTA benchmark without separate provenance.

## Audit result: REJECT for the GTA-level claim
...
not GTA VI-level realism. No individual dimension below can currently pass a
GTA-level acceptance gate based on the inspected street and night evidence.
...
signals only and cannot produce a GTA-level approval.
...
blind human evaluation nor an official GTA VI comparison.
...
from the official GTA VI media links above, not with copied image files:
...
score the Earth Online card alone for production quality; the official source
is a visual direction benchmark, not a claim that shots are equivalent. Use at
least **five independent reviewers**. Reveal labels and aggregate only after
all forms are locked. A majority score is never enough: every critical category
must meet its per-card floor.
...
is conditional; under 70 is reject. The GTA-level label additionally requires
...
- claimed GTA comparison uses unlicensed copied reference imagery.
...
- `.qa-patched-city-realmap-results.json` proves 57 functional checks passed;
  ...
  pedestrians at capture, insufficient evidence of GTA-grade density or
  behavior.
...
- No current legal reference manifest links a side-by-side review to official
  Rockstar sources; the new protocol corrects that without putting copyrighted
  media in the repo.
